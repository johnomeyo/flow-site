...
const ContactPage: React.FC = () => {
    ...
    return (
        <div className="bg-gray-50">
            ...
            {/* Page Title */}
            <section className="py-12 overflow-hidden" style={{ backgroundColor: '#f0f7fc' }}>
                <div className="container mx-auto px-6">
                    <motion.div
                    ...
                    >
                        <motion.h1 variants={fadeIn} className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                            Get in <span style={{ color: '#0674B4' }}>Touch</span>
                        </motion.h1>
                        <motion.p variants={fadeIn} className="text-lg text-gray-700 max-w-2xl mx-auto">
                            Have questions about Flow or ready to start your investment journey? Our team is here to help your vision become reality.
                        </motion.p>
                    </motion.div>
                </div>
            ...
            {/* CTA Section */}
            <section className="py-16 overflow-hidden" style={{ backgroundColor: '#f0f7fc' }}>
                <div className="container mx-auto px-6">
                    <motion.div
                        className="max-w-4xl mx-auto text-center"
                        initial="hidden"
                        ...
                        variants={staggerContainer}
                    >
                        <motion.h2 variants={fadeIn} className="text-3xl font-bold text-gray-900 mb-4">Ready to Transform Your Ideas Into Reality?</motion.h2>
                        <motion.p variants={fadeIn} className="text-lg text-gray-700 mb-8">Join thousands of successful startups and investors who are building the future with Flow.</motion.p>
